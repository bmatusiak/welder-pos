define(function(require, exports, module) {
    ...
    function invoiceTypeFNSetup(socket) {
        var obj = {};
    ...
    return function(docData) {
        ...
        window.socket(function(socket) {
            var actions = invoiceTypeFNSetup(socket);
            ...
            if (!loaded) {
                socket.emit("invoice-load", docData.invoiceid, function(err, doc) {
            ...
            function saveDoc(callback) {
                ...
                socket.emit("invoice-save", docData.invoiceid, draftObject, function(err, doc) {
                    saving = false;
